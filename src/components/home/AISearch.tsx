      ...
      <div className="bg-white rounded-3xl p-5 md:p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 flex flex-col items-center">
        ...
        <div className="w-full relative flex flex-col sm:flex-row items-center gap-3 sm:gap-0">
          ...
          <button
            ...
            className="w-full sm:w-auto sm:absolute right-3 top-1/2 sm:-translate-y-1/2 bg-blue-600 hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed text-white px-6 py-3 sm:py-2.5 rounded-xl sm:rounded-full font-medium transition-colors shadow-sm flex justify-center items-center gap-2"
          >
        ...
        <div className="flex items-center gap-3 mt-5 md:mt-6 text-sm text-gray-500 w-full overflow-x-auto pb-2 scrollbar-hide snap-x">
          ...
          {suggestions.map((suggestion) => (
            <button
              ...
              className="bg-gray-100 hover:bg-gray-200 text-gray-700 px-4 py-1.5 rounded-full transition-colors whitespace-nowrap shrink-0 snap-start"
            >
        ...
        <AiRecommend prompt={prompt} runKey={runKey} compact />
      </div>
    </div>
  );
}
