...
const rotatingWords = ["Smart", "Bold", "Swift", "Sharp", "Bold", "Elite", "Vivid", "NEXT"];
  ...
  return (
    <div className="relative w-full h-[80vh] min-h-[600px] flex items-center bg-black overflow-hidden group">
      ...
      <div className="absolute inset-0 z-0">
        <Image
          src="/34.jpg"
          alt="Laptop with online shopping"
          fill
      ...
      <div className="relative z-10 px-8 sm:px-16 lg:px-24 max-w-4xl">
        <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-[5rem] font-black text-white leading-[1.05] tracking-tight uppercase">
          <span className="block mb-2">
            Be{" "}
            <span className="text-[#ccff00] inline-block transition-all duration-300">
              {rotatingWords[wordIndex]}
            </span>
            <span className="text-[#ccff00]">.</span>
          </span>
          <span className="block">Be Continue.</span>
        </h1>
        ...
        <div className="mt-10">
          <button className="bg-[#ccff00] hover:bg-[#b3e600] text-black px-8 py-4 font-black uppercase tracking-wider text-sm transition-transform hover:-translate-y-1 min-w-[280px] flex items-center justify-center gap-2">
            Discover {categories[catIndex]} <ArrowRight size={18} />
          </button>
        </div>
      </div>
